...
class MR(TarDataset):
    ...
    @classmethod
    def splits(cls, text_field, label_field, user_field, dev_ratio=.1, shuffle=True, root='.', **kwargs):
        ...
        return (cls(text_field, label_field, user_field, examples=examples[:dev_index]),
                cls(text_field, label_field, user_field, examples=examples[dev_index:]))
