...
def mr(text_field, label_field, user_field, **kargs):
    ...
    # training_data=data.TabularDataset(path = 'data_twitter_sentiment/semeval_train.txt',format = 'tsv',fields = fields,skip_header = False)
    # train_data=data.TabularDataset(path = 'data_twitter_sentiment/semeval_train.txt',format = 'tsv',fields = fields,skip_header = False)
    # dev_data=data.TabularDataset(path = 'data_twitter_sentiment/Twitter2013_raw.txt',format = 'tsv',fields = fields,skip_header = False)
    # train_data, dev_data = training_data.split(split_ratio=0.7, random_state = random.seed(42))
    # for i in train_data:
    #     print(i)
